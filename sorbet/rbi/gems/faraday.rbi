...
class Faraday::RequestOptions < Anonymous_Faraday_Options_13
  def []=(key, value); end
end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_14
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_15
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_16
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_17
  def [](key); end
  def []=(key, value); end
  def clear_body; end
...
class Faraday::Request < Anonymous_Struct_18
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
