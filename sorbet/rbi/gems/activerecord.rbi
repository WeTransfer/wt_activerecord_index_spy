...
class Arel::Attributes::Attribute < Anonymous_Struct_5
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_6
end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_9
  def pretty_print(pp); end
end
...
class ActiveRecord::ConnectionAdapters::MySQL::SchemaCreation < ActiveRecord::ConnectionAdapters::SchemaCreation
  ...
  def visit_DropCheckConstraint(name); end
  def visit_DropForeignKey(name); end
  def visit_IndexDefinition(o, create = nil); end
end
...
class ActiveRecord::ConnectionAdapters::MySQL::TableDefinition < ActiveRecord::ConnectionAdapters::TableDefinition
  ...
  def charset; end
  def collation; end
  def initialize(conn, name, charset: nil, collation: nil, **arg4); end
  def integer_like_primary_key_type(type, options); end
...
class ActiveRecord::ConnectionAdapters::MySQL::TypeMetadata < Anonymous_Delegator_12
  def ==(other); end
  def deduplicated; end
  def eql?(other); end
  def extra; end
...
class ActiveRecord::ConnectionAdapters::AbstractMysqlAdapter < ActiveRecord::ConnectionAdapters::AbstractAdapter
  def add_index(table_name, column_name, **options); end
  def add_index_for_alter(table_name, column_name, **options); end
  ...
  def remove_index_for_alter(table_name, column_name = nil, **options); end
  def rename_column(table_name, column_name, new_column_name); end
  ...
  def supports_insert_on_duplicate_update?; end
  def supports_optimizer_hints?; end
  def supports_rename_column?; end
...
module ActiveRecord::ConnectionAdapters::MySQL::DatabaseStatements
  ...
  def multi_statements_enabled?; end
  def query(sql, name = nil); end
