  ...
  RSpec.describe Aggregator do
    ...
    describe "#export_html_results" do
      it "returns an html with results" do
        aggregator = described_class.new
        aggregator.add(build_item(identifier: "aa", query: "SELECT 1", origin: "lala.rb", certainity_level: :certain))
        aggregator.add(build_item(identifier: "bb", query: "SELECT 2", origin: "lala.rb", certainity_level: :uncertain))
        aggregator.add(build_item(identifier: "aa", query: "SELECT 1", origin: "popo.rb", certainity_level: :certain))
